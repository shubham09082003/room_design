...
function Stats() {
  return (
    <div className="flex flex-col sm:flex-col md:flex-row lg:flex-row justify-around gap-5 p-5 mt-20 bg-gradient-to-b from-[#5a2853] to-[#010000] md:w-[1280px] lg:w-[1280px] w-[90%] mx-auto rounded-lg sm:gap-4 sm:px-5">
